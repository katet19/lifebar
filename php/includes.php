...
require_once 'controller_dashboard.php';
...
require_once 'controller_import.php';
...
require_once 'controller_discover.php';
require_once 'controller_daily.php';
require_once 'controller_ranking.php';
//Errors
...
require_once 'view_analyze.php';
require_once 'view_badge.php';
require_once 'view_collection.php';
