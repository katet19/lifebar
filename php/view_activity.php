	...
	<div class="row" style='margin-bottom: 30px;'>
		...
		<div class="feed-activity-icon-col">
				<?php if($user->_security == "Journalist"){ ?>
					<div class="feed-activity-icon-xp" style='background-color:#FF5252;'><i class="mdi-action-subject"></i></div>
				<?php }else if(sizeof($feed) > 0){ ?>
					<div class="feed-activity-icon-xp" style='background-color:#FF5252;'><span style='font-size: 0.8em;font-weight: bold;line-height: 28px;'>XP</span></div>
				<?php }else if(strtotime($feed[0][3]->_date) < strtotime("now -182 days")){ ?> 
					<div class="feed-activity-icon-xp" style='background-color:#FF5252;'><i class="mdi-device-access-time"></i></div>
				<?php }else if($feed[0][0]->_event == "FINISHED"){ ?>
					<div class="feed-activity-icon-xp" style='background-color:#FF5252;'><i class="mdi-action-done"></i></div>
				<?php }else if(sizeof($feed[0][3]->_watchedxp) > 0 && sizeof($feed[0][3]->_playedxp) > 0){ ?>
					<div class="feed-activity-icon-xp" style='background-color:#FF5252;'><i class="mdi-content-create"></i></div>
...
?>
	<div class="row" style='margin-bottom: 30px;'>
		...
		<div class="feed-activity-icon-col">
			<div class="feed-activity-icon-xp" style='background-color:#FF5252;'><i class="mdi-social-people"></i></div>
		</div>
		<div class="feed-content-col">
			<div class="feed-activity-title">
				<?php if(sizeof($feed) > 1){ ?>
...
?>
	<div class="row" style='margin-bottom: 30px;'>
		...
		<div class="feed-activity-icon-col">
			<div class="feed-activity-icon-xp" style='background-color:#FF5252;'><i class="mdi-image-collections"></i></div>
		</div>
		<div class="feed-content-col">
			<div class="feed-activity-title">
				<?php if(sizeof($feed) > 1){ ?>
...
?>
	<div class="row" style='margin-bottom: 30px;'>
		...
		<div class="feed-activity-icon-col">
			<div class="feed-activity-icon-xp" style='background-color:#FF5252;'><i class="mdi-action-bookmark"></i></div>
		</div>
		<div class="feed-content-col">
			<div class="feed-activity-title">
				<?php if(sizeof($feed) > 1){ ?>
...
?>
	<div class="row" style='margin-bottom: 30px;'>
		...
		<div class="feed-activity-icon-col">
			<div class="feed-activity-icon-xp" style='background-color:#FF5252;'><i class="mdi-action-swap-vert"></i></div>
		</div>
		<div class="feed-content-col">
				<div class="feed-activity-title">
					<span class="feed-activity-user-link" data-id="<?php echo $user->_id; ?>"><?php echo $username; ?></span>
...
?>
	<div class="row" style='margin-bottom: 30px;'>
		...
		<div class="feed-activity-icon-col">
			<div class="feed-activity-icon-xp" style='background-color:#FF5252;'><i class="mdi-action-description"></i></div>
		</div>
		<div class="feed-content-col">
				<div class="feed-activity-title">
					<span class="feed-activity-user-link" data-id="<?php echo $user->_id; ?>"><?php echo $username; ?></span>
...
function FeedGameReleasesItem($feed){ ?>
	<div class="row" style='margin-bottom: 30px;'>
		...
		<div class="feed-activity-icon-col">
			<div class="feed-activity-icon-xp" style='background-color:#FF5252;'><i class="mdi-action-event"></i></div>
		</div>
		<div class="feed-content-col">
				<div class="feed-activity-title">
					<?php if(sizeof($feed) > 1){ ?>
...
?>
	<div class="row" style='margin-bottom: 30px;'>
		...
		<div class="feed-activity-icon-col">
			<div class="feed-activity-icon-xp" style='background-color:#FF5252;'><i class="fa fa-steam"></i></div>
		</div>
		<div class="feed-content-col">
				<div class="feed-activity-title">
					<span class="feed-activity-user-link" data-id="<?php echo $user->_id; ?>"><?php echo $username; ?></span>
