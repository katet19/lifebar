...
function AddAgreedEmail($gameid, $userid, $agreedwith, $eventid){
	if(UserIsSub($agreedwith, '1up')){
		...
		$body = $body."<div style='font-size:1.5em;padding: 0 50px 20px;'><b>".$username."</b> appreciated your thoughts on <i>".$game->_title."</i> and gave you a 1up!</div>";
		$body = $body."<a href='http://lifebar.io/1/u.php?i=e".$eventid."' style='text-decoration:none;font-weight:bold;font-size:1.25em;color:white;background-color:#2196F3;cursor:pointer;text-align:center;padding:5px 0px;width:100px;margin-bottom:30px;display:inline-block;'>VIEW</a>";
