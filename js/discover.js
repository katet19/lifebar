...
function AttachDiscoverHomeEvents(){
	...
	$(".game-card-quick-dismiss").on("click", function(e){
		...
		if($(".hidingLifebarBacklog").length >= 6){
			$(this).parent().parent().parent().parent().parent().append("<div style='font-size:1.25em;font-weight:400;margin: 75px 0 50px;'>Congrats! You finished going through a slice of your backlog</div>")
		}
	});
